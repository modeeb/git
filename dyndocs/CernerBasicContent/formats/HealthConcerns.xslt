...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <!-- Only display MU3 Health Concerns (v1) -->
        <xsl:if test="n:report/n:clinical-data/n:health-concern-data/n:health-concern[exists(@category-code)]">
            <ul style="list-style-type: disc; margin: 0; padding-left: 1em;">
                <!-- Only display MU3 Health Concerns (v1) -->
                <xsl:for-each select="n:report/n:clinical-data/n:health-concern-data/n:health-concern[exists(@category-code)]">
                    ...
                    <li class="ddemrcontentitem ddremovable" dd:btnfloatingstyle="top-right" >
                        ...
                        <div>
                            ...
                            <!-- Display the health concern description text followed by the category in parantheses -->
    ...
    <xsl:template name="tempDisplayComments">
        ...
        <xsl:if test="not(empty(n:comments/text()))">
            <div class="ddgrouper ddremovable" dd:btnfloatingstyle="top-right" style="margin-left: 0em; padding-left: 2em;text-indent: -1em;">
