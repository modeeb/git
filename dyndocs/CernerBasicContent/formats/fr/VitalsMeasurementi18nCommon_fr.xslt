...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="maxTemp" as="xs:string">
		<xsl:value-of select="'Temp&#233;rature maximum'"/>
	</xsl:variable>
	<xsl:variable name="minTemp" as="xs:string">
		<xsl:value-of select="'Temp&#233;rature minimum'"/>
	</xsl:variable>
	...
	<xsl:variable name="sMthdMonitored" as="xs:string"><xsl:value-of select="'Sous surveillance'"/></xsl:variable>
	...
	<xsl:variable name="sMthdWeightEstimated" as="xs:string" select="'Estim&#233;'"/>
	<xsl:variable name="sMthdWeightDosing" as="xs:string" select="'Posologie'"/>
	<xsl:variable name="sMthdWeightBirth" as="xs:string" select="'Naissance'"/>
