...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="DisplayNote" as="xs:string">
		<xsl:value-of select="'Tout m&#233;dicament prescrit qui n&#8217;est pas not&#233; ci-dessus doit &#234;tre pris comme prescrit. En cas de question ou dn&#8217;estinqui&#233;tude concernant vos autres m&#233;dicaments, contactez le soignant prescripteur.'"/>
	</xsl:variable>

	<xsl:variable name="UnchangedMedsDisplayNote" as="xs:string">
		<xsl:value-of select="'Tout m&#233;dicament prescrit doit &#234;tre pris comme prescrit. En cas de question ou dn&#8217;est inqui&#233;tude concernant vos autres m&#233;dicaments, contactez le soignant prescripteur.'"/>
	</xsl:variable>
