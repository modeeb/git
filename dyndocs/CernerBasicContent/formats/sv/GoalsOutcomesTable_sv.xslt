...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="goalHeading" as="xs:string" select="'M&#229;lbeskrivning'"/>
	<xsl:variable name="isMetHeading" as="xs:string" select="'Uppn&#229;tt/ej uppn&#229;tt'"/>
	<xsl:variable name="outcomeHeading" as="xs:string" select="'Utfall'"/>
