...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Comment out this line to debug--> <xsl:import href="/cernerbasiccontent/formats/sv/addressfxn_sv.xslt"/>
    <!-- Uncomment this line to debug <xsl:import href="AddressFxn_sv.xslt"/> -->
	...
	<xsl:variable name="VideoVisit" as="xs:string">
        <xsl:value-of select="'Videobes&#246;k'"/>
    </xsl:variable>
