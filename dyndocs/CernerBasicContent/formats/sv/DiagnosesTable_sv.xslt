...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:variable name="diagnosisHeading" as="xs:string" select="'Diagnos'"/>
    <xsl:variable name="typeHeading" as="xs:string" select="'Typ'"/>
    <xsl:variable name="diagnosisDateHeading" as="xs:string" select="'Diagnosdatum'"/>
    <xsl:variable name="qualifierHeading" as="xs:string" select="'Kvalificerare'"/>
    <xsl:variable name="clinicalServiceHeading" as="xs:string" select="'Klinisk tj&#228;nst'"/>
