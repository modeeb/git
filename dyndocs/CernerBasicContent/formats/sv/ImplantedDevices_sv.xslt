...
<xsl:stylesheet version="2.0" 
	...
	<xsl:variable name="ImplantedThisVisitTitle" as="xs:string" select="'Implanterad vid detta bes&#246;k'"/>
	<xsl:variable name="ExplantedThisVisitTitle" as="xs:string" select="'Borttagen vid detta bes&#246;k'"/>
	<xsl:variable name="MRUnsafeAlert" as="xs:string" select="'Obs! Under detta bes&#246;k har patienten f&#229;tt enheter implanterade. De &#228;r inte kompatibla med magnetresonanstomografi (MRT).'"/>
	<xsl:variable name="MRPossiblyUnsafeAlert" as="xs:string" select="'Obs! Under detta bes&#246;k har patienten f&#229;tt enheter implanterade. De &#228;r eventuellt inte kompatibla med magnetresonanstomografi (MRT).'"/>
