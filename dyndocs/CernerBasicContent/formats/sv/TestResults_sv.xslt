...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="ContactForPendingResults" as="xs:string" select="'Du blir kontaktad inom 72 timmar ang&#229;ende dina resultat.'"/>
	...
	<xsl:variable name="laboratoryCatalogMeaning" as="xs:string" select="'Allm&#228;nt labb'"/>
	<xsl:variable name="radiologyCatalogMeaning" as="xs:string" select="'Radiologi'"/>
