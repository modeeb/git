    ...
    <xsl:template match="/"> 
        ...
        <xsl:if test="exists($LatestMeasurements/n:measurement)">
            <xsl:for-each select="$LatestMeasurements/n:measurement[n:event-type]">
                ...
                <!-- The style attribute with margin-left: 0em; is for the pdf creation
                     out of IBEX or FOP. Please refer 
                     https://jira2.cerner.com/browse/DYNAMICDOC-2571 -->
                <div class="ddemrcontentitem ddremovable" dd:btnfloatingstyle="top-right" style="text-indent: -1em; margin-left: 0em; padding-left: 1em;">
