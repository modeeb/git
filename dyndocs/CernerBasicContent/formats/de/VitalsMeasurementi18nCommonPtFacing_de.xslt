...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="sMthdWeightEstimated" as="xs:string" select="'Gesch&#228;tzt'"/>
	<xsl:variable name="sMthdWeightDosing" as="xs:string" select="'Dosierung'"/>
	<xsl:variable name="sMthdWeightBirth" as="xs:string" select="'Geburt'"/>
