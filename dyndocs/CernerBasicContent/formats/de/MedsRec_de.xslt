...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="DisplayNote" as="xs:string">
		<xsl:value-of select="'Alle nicht oben stehenden verschriebenen Medikationen sollten wie verschrieben eingenommen werden. Kontaktieren Sie bei Fragen oder Bedenken zu anderen Medikationen den verschreibenden Mitarbeiter.'"/>
	</xsl:variable>

	<xsl:variable name="UnchangedMedsDisplayNote" as="xs:string">
		<xsl:value-of select="'Verschriebene Medikationen sollten wie verschrieben eingenommen werden. Kontaktieren Sie bei Fragen oder Bedenken zu anderen Medikationen den verschreibenden Mitarbeiter.'"/>
	</xsl:variable>
