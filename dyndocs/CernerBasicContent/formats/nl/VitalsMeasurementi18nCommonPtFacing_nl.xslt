...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="sAbbrvRespiratoryRate" as="xs:string"><xsl:value-of select="'Ademhalingsfrequentie'"/></xsl:variable>
	<xsl:variable name="sAbbrvBloodPressure" as="xs:string"><xsl:value-of select="'Bloeddruk'"/></xsl:variable>
	<xsl:variable name="sAbbrvOrthoBloodPressure" as="xs:string"><xsl:value-of select="'Orthostatische BD'"/></xsl:variable>
	...
	<xsl:variable name="sMthdTemporalArtery" as="xs:string"><xsl:value-of select="'Slaapslagader'"/></xsl:variable>
	...
	<xsl:variable name="sMthdWeightEstimated" as="xs:string" select="'Geschat'"/>
	<xsl:variable name="sMthdWeightDosing" as="xs:string" select="'Dosering'"/>
	<xsl:variable name="sMthdWeightBirth" as="xs:string" select="'Geboorte'"/>
