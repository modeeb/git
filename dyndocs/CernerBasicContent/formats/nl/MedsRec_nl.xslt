...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="DisplayNote" as="xs:string">
		<xsl:value-of select="'Alle voorgeschreven medicaties die hierboven niet worden genoemd, moeten worden gebruikt zoals staat voorgeschreven. Als u vragen of twijfels heeft over uw andere medicaties, moet u contact opnemen met de zorgverlener die u deze medicaties heeft voorgeschreven.'"/>
	</xsl:variable>

	<xsl:variable name="UnchangedMedsDisplayNote" as="xs:string">
		<xsl:value-of select="'Alle voorgeschreven medicaties moeten worden gebruikt zoals staat voorgeschreven. Als u vragen of twijfels heeft over uw andere medicaties, moet u contact opnemen met de zorgverlener die u deze medicaties heeft voorgeschreven.'"/>
	</xsl:variable>
</xsl:stylesheet>
