...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="MRN" as="xs:string">
        <xsl:value-of select="'Pati&#235;ntnummer:'"/>
    </xsl:variable>
	...
	<xsl:variable name="Facility" as="xs:string">
        <xsl:value-of select="'Instelling:'"/>
    </xsl:variable>
	
	<xsl:variable name="FacilityPhone" as="xs:string">
        <xsl:value-of select="'Telefoonnummer instelling:'"/>
    </xsl:variable>
	
	<xsl:variable name="NurseUnit" as="xs:string">
        <xsl:value-of select="'Verpleegafdeling:'"/>
    </xsl:variable>
	
	<xsl:variable name="NursePhone" as="xs:string">
        <xsl:value-of select="'Telefoonnummer verpleegafdeling:'"/>
    </xsl:variable>
