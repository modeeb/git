...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="StopTaking" as="xs:string">
		<xsl:value-of select="'Encerrar administra&#231;&#227;o'"/>
	</xsl:variable>
	...
	<xsl:variable name="DisplayNote" as="xs:string">
		<xsl:value-of select="'Qualquer medica&#231;&#227;o receitada n&#227;o anotada acima deve ser tomada conforme a receita. Se tiver uma pergunta sobre qualquer outra medica&#231;&#227;o, contate o profissional prescritor'"/>
	</xsl:variable>

	<xsl:variable name="UnchangedMedsDisplayNote" as="xs:string">
		<xsl:value-of select="'Qualquer medica&#231;&#227;o receitada deve ser tomada conforme a receita. Se tiver uma pergunta sobre qualquer outra medica&#231;&#227;o, contate o profissional prescritor'"/>
	</xsl:variable>
