...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="sAbbrvHeartRate" as="xs:string"><xsl:value-of select="'FC'"/></xsl:variable>
	<xsl:variable name="sAbbrvRespiratoryRate" as="xs:string"><xsl:value-of select="'FR'"/></xsl:variable>
	<xsl:variable name="sAbbrvBloodPressure" as="xs:string"><xsl:value-of select="'PA'"/></xsl:variable>
	...
	<xsl:variable name="sAbbrvNIH" as="xs:string"><xsl:value-of select="'Puntuaci&#243;n en Escala de ictus NIH'"/></xsl:variable>
	...
	<xsl:variable name="sMthdline" as="xs:string"><xsl:value-of select="'V&#237;a'"/></xsl:variable>
	<xsl:variable name="sMthdsitting" as="xs:string"><xsl:value-of select="'En sedestaci&#243;n'"/></xsl:variable>
	<xsl:variable name="sMthdstanding" as="xs:string"><xsl:value-of select="'En bipedestaci&#243;n'"/></xsl:variable>
	...
	<xsl:variable name="sMthdWeightEstimated" as="xs:string" select="'Estimado'"/>
	<xsl:variable name="sMthdWeightDosing" as="xs:string" select="'Dosificaci&#243;n'"/>
	<xsl:variable name="sMthdWeightBirth" as="xs:string" select="'Nacimiento'"/>
