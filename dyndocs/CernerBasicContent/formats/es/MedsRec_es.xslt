...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="DisplayNote" as="xs:string">
		<xsl:value-of select="'Cualquier medicaci&#243;n prescrita que no se haya documentado arriba se deber&#225; administrar conforme se ha prescrito. Si tiene alguna duda o consulta acerca de sus otras medicaciones, p&#243;ngase en contacto con el profesional asistencial prescriptor.'"/>
	</xsl:variable>

	<xsl:variable name="UnchangedMedsDisplayNote" as="xs:string">
		<xsl:value-of select="'Las medicaciones prescritas deben administrarse conforme se han prescrito. Si tiene alguna duda o consulta acerca de sus otras medicaciones, p&#243;ngase en contacto con el profesional asistencial prescriptor.'"/>
	</xsl:variable>
