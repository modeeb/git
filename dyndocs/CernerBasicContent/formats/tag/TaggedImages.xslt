...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="formatClipboardImage">
		...
		<div xmlns:dd="DynamicDocumentation" class="ddemrcontentitem">
			...
			<img class="ddimageclipboard" style="float:left;height:44px;overflow:hidden;text-overflow:ellipsis;word-wrap:normal;white-space:nowrap;padding-top:6px;padding-bottom:6px">
