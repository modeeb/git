...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="CriticalRangeImage">
	<img width="10px" height="10px" src='data:image/png;base64,'/>
	</xsl:variable>
	
	<xsl:variable name="AbnormalRangeImage">
	<img width="10px" height="10px" src='data:image/png;base64,'/>
	</xsl:variable>
	
	<xsl:variable name="HighRangeImage">
	<img width="10px" height="10px" src='data:image/png;base64,'/>
	</xsl:variable>
	
	<xsl:variable name="LowRangeImage">
	<img width="10px" height="10px" src='data:image/png;base64,'/>
	</xsl:variable>
	...
	<xsl:function name="cdocfx:getCodeDescriptionByID">
		<xsl:param name="code_id" as="xs:string"/>
		<xsl:value-of select="key('code_values', $code_id, $root-node)/@description"/>
	</xsl:function>
	...
	<xsl:function name="cdocfx:getOrderCatalogName">
		<xsl:param name="order_catalog_id" as="xs:string"/>
		<xsl:value-of select="key('order_catalog', $order_catalog_id, $root-node)/@name"/>
	</xsl:function>
	...
	<!-- Parameters: -->
	<!--  measurement - the measurement node -->
	<xsl:function name="cdocfx:getMeasurementInterpretationLabs">
		<xsl:param name="measurement"/>
		<xsl:choose>
			<xsl:when test="$measurement/@interpretation-code">
				<xsl:variable name="Interpretation" as="xs:string">
	...
	<!-- Detect if given order has medication details before bolding output -->
	<!-- Parameters: -->
	<!-- 	order - the order node -->
	<xsl:function name="cdocfx:hasMedDetails" as="xs:boolean">
		<xsl:param name="order"/>
		<xsl:choose>
			<xsl:when test="exists($order/n:medication-ingredient/n:dose) or exists($order/@route-of-administration-code) 
				or exists($order/n:order-schedule/n:frequency) or ($order/n:order-schedule/@is-prn = 'true') 
				or ($order/@total-fills &gt; 0)">
				<xsl:value-of select="fn:true()"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="fn:false()"/>
	...
	<!-- Template to get the code value by id and display them in alphabetical order -->
	<xsl:template name="getCodeDisplayAlphabetically">
			<xsl:param name="node"/>
			<xsl:param name="multipleValueSeparator"/>
			<xsl:variable name="finalDisplayString"><!-- Variable to return all the node values-->
				<!--Looping for all values when one or more nodes are there-->
				<xsl:for-each select="$node">
					<!-- Displaying the node values in alphabetical order -->
					<xsl:sort select="cdocfx:getCodeDisplayByID(.)" order="ascending"/>
					<xsl:value-of select="cdocfx:getCodeDisplayByID(.)"/>
					<xsl:if test="position() != last()"><!-- If this is not the last item, display a comma-space between the node values -->
						<xsl:value-of select="$multipleValueSeparator" />
					</xsl:if>
				</xsl:for-each>
			</xsl:variable>
		<xsl:value-of select="$finalDisplayString" />
	</xsl:template>
	
	<!--Template to get the Generic name (@reference-name) and Brand name (@display-mnemonic) of the order -->
	<xsl:template name="APandOrdersNameDisplay">
		<xsl:param name="order" />

		<xsl:choose>
			<xsl:when test="$order/@reference-name or $order/@display-mnemonic">
				<xsl:choose>
					<xsl:when test="$order/@reference-name != $order/@display-mnemonic">
						<span style="padding-right:2px;font-weight:bold;">
							<xsl:value-of select="$order/@reference-name"/>
						</span>
						<xsl:text>(</xsl:text>
						<xsl:value-of select="$order/@display-mnemonic"/>
						<xsl:text>)</xsl:text>	
					</xsl:when>
					<xsl:otherwise>
						<span style="font-weight:bold;"> 
							<xsl:value-of select="(if (exists($order/@reference-name)) then $order/@reference-name else $order/@display-mnemonic)"/>
						</span>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
