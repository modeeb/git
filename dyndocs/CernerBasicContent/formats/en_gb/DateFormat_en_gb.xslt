...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="DATE_SEQUENCE_UTC_ON_WITH_TIME" as="xs:string" select="$DATE_SEQUENCE_UTC_ON"/>
	<xsl:variable name="DATE_SEQUENCE_UTC_ON_WITHOUT_TIME" as="xs:string" select="'dd/MM/yyyy zzz'"/>
	<xsl:variable name="DATE_SEQUENCE_UTC_OFF_WITH_TIME" as="xs:string" select="$DATE_SEQUENCE_UTC_OFF"/>
