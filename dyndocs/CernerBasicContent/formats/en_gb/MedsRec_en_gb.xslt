...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xsl:variable name="DisplayNote" as="xs:string">
		<xsl:value-of select="'Any prescribed medications not noted above should be taken as prescribed. If you have a question or concern regarding any of your other medications please contact the prescribing clinical staff.'"/>
	</xsl:variable>

	<xsl:variable name="UnchangedMedsDisplayNote" as="xs:string">
		<xsl:value-of select="'Any prescribed medications should be taken as prescribed. If you have a question or concern regarding any of your other medications please contact the prescribing clinical staff.'"/>
	</xsl:variable>
