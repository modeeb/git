...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="commentColHeading" as="xs:string" select="if(($measurements/measurement/@comment) and $ShowComments)  then $ColumnHeadingThree else ''"/>
        ...
        <!-- i.e., this row(spanningRowTwoLabel) is associated with the previous row -->
            <xsl:call-template name="tempMeasurementsTable">
                ...
                <xsl:with-param name="colHeadingThree" select="''"/>
